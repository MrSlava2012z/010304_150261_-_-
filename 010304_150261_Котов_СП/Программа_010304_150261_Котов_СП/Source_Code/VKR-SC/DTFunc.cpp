...
//---Меню---
    ...
    {//A. Ввод данных и расчёт оптимальной ветви
        ...
        QString TA06="Введите вероятность высокого спроса [%-ты 10-й дробью <1] за "; //TA06
        //---
        QString TA07="Введите прогнозируемую прибыль при низком спросе [в млн у.е.] за "; //TA07
        QString TA08="Введите вероятность низкого спроса [%-ты 10-й дробью <1] за "; //TA08
        //---
        ...
        //---
        QString TA74="1 год - не показатель. Стоит обратить внимание на результат за следующие годы.\n"; //TA74
        //---
        QString TA75="*** Напоминание: разделительный символ дробей точка (.) , а не запятая (,) ***\n"; //TA75
        //---
        ...
        cout<<endl;
        cout<<TA75.toLocal8Bit().data(); //TA75
        cout<<endl;
        ...
        for (int i=0; i<=4; i++)
        {
            ...
            //---
            cout<<endl;
            cout<<TA05.toLocal8Bit().data()<<j+1<<TA09.toLocal8Bit().data()<<TA13.toLocal8Bit().data(); //TA05, TA09, TA13 - j
            cin>>A[j]; //A0, A1, A2, A3, A4
            cout<<endl<<endl;
            cout<<TA06.toLocal8Bit().data()<<j+1<<TA09.toLocal8Bit().data()<<TA21.toLocal8Bit().data(); //TA06, TA09, TA21 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA07.toLocal8Bit().data()<<j+1<<TA09.toLocal8Bit().data()<<TA14.toLocal8Bit().data(); //TA07, TA09, TA14 - j
            cin>>B[j]; //B0, B1, B2, B3, B4
            cout<<endl<<endl;
            cout<<TA08.toLocal8Bit().data()<<j+1<<TA09.toLocal8Bit().data()<<TA22.toLocal8Bit().data(); //TA08, TA09, TA22 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA05.toLocal8Bit().data()<<j+1<<TA10.toLocal8Bit().data()<<TA15.toLocal8Bit().data(); //TA05, TA10, TA15 - j
            cin>>C[j]; //C0, C1, C2, C3, C4
            cout<<endl<<endl;
            cout<<TA06.toLocal8Bit().data()<<j+1<<TA10.toLocal8Bit().data()<<TA23.toLocal8Bit().data(); //TA06, TA10, TA23 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA07.toLocal8Bit().data()<<j+1<<TA10.toLocal8Bit().data()<<TA16.toLocal8Bit().data(); //TA07, TA10, TA16 - j
            cin>>D[j]; //D0, D1, D2, D3, D4
            cout<<endl<<endl;
            cout<<TA08.toLocal8Bit().data()<<j+1<<TA10.toLocal8Bit().data()<<TA24.toLocal8Bit().data(); //TA08, TA10, TA24 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA05.toLocal8Bit().data()<<j+1<<TA11.toLocal8Bit().data()<<TA17.toLocal8Bit().data(); //TA05, TA11, TA17 - j
            cin>>E[j]; //E0, E1, E2, E3, E4
            cout<<endl<<endl;
            cout<<TA06.toLocal8Bit().data()<<j+1<<TA11.toLocal8Bit().data()<<TA25.toLocal8Bit().data(); //TA06, TA11, TA25 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA07.toLocal8Bit().data()<<j+1<<TA11.toLocal8Bit().data()<<TA18.toLocal8Bit().data(); //TA07, TA11, TA18 - j
            cin>>F[j]; //F0, F1, F2, F3, F4
            cout<<endl<<endl;
            cout<<TA08.toLocal8Bit().data()<<j+1<<TA11.toLocal8Bit().data()<<TA26.toLocal8Bit().data(); //TA08, TA11, TA26 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA05.toLocal8Bit().data()<<j+1<<TA12.toLocal8Bit().data()<<TA19.toLocal8Bit().data(); //TA05, TA12, TA19 - j
            cin>>G[j]; //G0, G1, G2, G3, G4
            cout<<endl<<endl;
            cout<<TA06.toLocal8Bit().data()<<j+1<<TA12.toLocal8Bit().data()<<TA27.toLocal8Bit().data(); //TA06, TA12, TA27 - j
            ...
            cout<<"--------------------------------------------------------------------"<<endl;
            cout<<endl;
            cout<<TA07.toLocal8Bit().data()<<j+1<<TA12.toLocal8Bit().data()<<TA20.toLocal8Bit().data(); //TA07, TA12, TA20 - j
            cin>>H[j]; //H0, H1, H2, H3, H4
            cout<<endl<<endl;
            cout<<TA08.toLocal8Bit().data()<<j+1<<TA12.toLocal8Bit().data()<<TA28.toLocal8Bit().data(); //TA08, TA12, TA28 - j
        ...
        for (int k=0; k<5; k++)
        {
            ...
            //---
                  if (j==0) {cout<<TA74.toLocal8Bit().data()<<endl;} //TA74
                  if (j!=4) {system("pause");}
            //---
        }
        //---
